  ...
  return (
    <div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        ...
        {remainingDays < 0 ? (
          <div className="flex-1 text-justify p-3 bg-[#1c1c24] rounded-[10px]">
            <h2 className="p-3 mb-4 text-center font-epilogue font-semibold text-[18px] text-white uppercase">
              {" "}
              Campaign is Closed!
            </h2>
            ...
            <h2 className="mt-3 font-epilogue font-normal text-[16px] text-[#9c9eb0]">
              {" "}
